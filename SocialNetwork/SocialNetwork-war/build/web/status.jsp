<%--
   ...
   - Description: This section will show latest 6 posts of the system.
   --%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="bootstrap-3.3.5-dist/js/jquery.redirect.js"></script>
        <script type="text/javascript" src="SpryAssets/StatusDetail.js"></script>
