<%--
   ...
   - Description: This page is about the profile of the logged-in user.
   --%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="SpryAssets/GeneralPopUpForm.js"></script>
            ...
            <table width="538" height="391" cellpadding="1" cellspacing="1">
                <tr>
                    <td width="264" rowspan="3" align="center">
                        <%
        String picName = request.getSession().getAttribute("UserId").toString();
        if (!picName.equals("null")) {
            picName += ".jpg";// to avoid null pointer exception while running.
        }
