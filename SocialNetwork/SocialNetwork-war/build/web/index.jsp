...
<%@page import="mm.com.aidatech.utilities.www.DatabaseLoader" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="SpryAssets/GeneralForm.css"></script>
    ...
    <body>
        <%
        // to check that database connection can load from db.conf file
        if (new DatabaseLoader().getDbUrl().isEmpty()) {
